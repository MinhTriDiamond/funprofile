...
-- Update get_content_users_by_period_vn: rewards section uses reward_claims instead of light_actions
...
-- Update get_user_posts_by_period_vn: rewards section uses reward_claims instead of light_actions
