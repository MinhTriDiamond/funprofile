...
CREATE OR REPLACE FUNCTION get_user_donation_summary(p_user_id uuid)
RETURNS jsonb
LANGUAGE sql
STABLE
SECURITY DEFINER
...
AS $$
  ...
  -- Get all donation tx_hashes for this user to exclude duplicates from wallet_transfers
