...
CREATE OR REPLACE FUNCTION public.get_user_honor_stats(p_user_id uuid)
 RETURNS TABLE(posts_count bigint, reactions_on_posts bigint, comments_count bigint, shares_count bigint, friends_count bigint, livestreams_count bigint, total_reward numeric, today_reward numeric, claimed_amount numeric)
 LANGUAGE plpgsql
 SECURITY DEFINER
...
BEGIN
  ...
  -- Add PPLP rewards (from Angel AI scoring system)
