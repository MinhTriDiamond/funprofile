...
BEGIN
  ...
  claimed AS (
    -- Total CAMLY spent from Treasury = all donations sent by Treasury account
    -- This includes reward claims (also recorded as donations) + manual gifts
    -- After backfill, this will match on-chain total
