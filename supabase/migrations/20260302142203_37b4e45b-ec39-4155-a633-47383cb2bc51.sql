...
RETURNS TABLE(
  ...
  wallet_address text, created_at timestamptz, is_banned boolean,
  pending_reward bigint, approved_reward bigint, reward_status text,
  posts_count bigint, comments_count bigint, reactions_on_posts bigint,
  friends_count bigint, shares_count bigint, livestreams_count bigint,
  total_light_score numeric, tier integer, total_minted numeric,
  camly_calculated bigint, camly_today bigint, camly_claimed numeric,
  usdt_received numeric, internal_sent numeric, internal_received numeric,
  web3_sent numeric, web3_received numeric, email text
)
LANGUAGE plpgsql
