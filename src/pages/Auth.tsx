      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-16 relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center -top-8">
            <div className="w-56 h-56 rounded-full bg-gradient-to-br from-yellow-400/60 via-emerald-400/50 to-yellow-500/60 blur-3xl animate-pulse" style={{
          ...
          <div className="relative z-10">
            <div className="w-36 h-36 mx-auto rounded-full bg-gradient-to-br from-yellow-400/20 to-emerald-400/20 p-2 backdrop-blur-sm">
              <img alt="FUN Profile WEB3" className="w-full h-full rounded-full ring-4 ring-yellow-400/50 shadow-2xl" style={{
              filter: 'drop-shadow(0 0 40px rgba(234, 179, 8, 0.8)) drop-shadow(0 0 20px rgba(16, 185, 129, 0.8))'
            }} src="/lovable-uploads/17dfd5bd-61db-4676-9b2c-207708df90d8.png" />
            </div>
          </div>
        </div>
        <AuthForm />
