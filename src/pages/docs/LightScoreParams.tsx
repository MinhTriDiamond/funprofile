...
export default function LightScoreParamsDocs() {
  ...
  return (
    <>
      <Helmet>
        <title>Light Score Parameter Table v1.0 — fun.rich</title>
        <meta name="description" content="Bảng tham số chính thức của hệ Light Score v2.5: 14 events, 11 multipliers, 4 legacy params, 3 phases, Mint linking và Stability Index." />
        <link rel="canonical" href="https://funprofile.lovable.app/docs/light-score-params" />
      </Helmet>
      ...
      <div className="container max-w-5xl mx-auto py-10 px-4 space-y-8">
        ...
        {/* Section III — Multipliers */}
        <Section title="III. 11 Multipliers (Event/Personal/Network)" icon={<Activity className="w-5 h-5" />}>
          <DataTable
          ...
          />
          <p className="text-xs text-muted-foreground mt-2">⚠️ Trigger DB enforce: range_max ≤ 5.0 cho mọi multiplier.</p>
        </Section>
