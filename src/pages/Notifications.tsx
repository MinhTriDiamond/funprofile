...
const Notifications = () => {
  ...
  return (
    <div className="min-h-screen bg-background pb-20 lg:pb-0 pt-36 md:pt-40">
      {/* Header */}
      <div className="sticky top-36 md:top-40 z-40 bg-background/95 backdrop-blur-sm border-b border-border">
