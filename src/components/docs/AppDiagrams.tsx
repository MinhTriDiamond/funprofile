...
export const RewardFlowDiagram: React.FC = () => (
  <DiagramWrapper title="Hệ Thống Reward Flow">
    <div className="w-full max-w-4xl">
      {/* Formula */}
      <div className="bg-primary/10 rounded-xl p-4 border border-primary/30 mb-6 text-center">
        <h5 className="text-primary font-bold mb-2">📐 Công Thức Tính Reward</h5>
        <code className="text-sm bg-background/80 px-4 py-2 rounded-lg text-muted-foreground">
          Total = (posts × 50) + (comments × 10) + (reactions × 2) + (friends × 25) + (shares × 15)
        </code>
      </div>
      ...
      <div className="grid grid-cols-5 gap-3 mb-6">
        ...
        <div className="bg-pink-500/20 rounded-xl p-3 text-center border border-pink-500/30">
          ...
          <div className="text-pink-400 font-bold">2</div>
    ...
    <div className="w-full max-w-5xl">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <div className="col-span-2 md:col-span-1 bg-emerald-500/10 rounded-xl p-3 border border-emerald-500/30">
          <h6 className="text-emerald-400 font-bold text-sm mb-2">📝 Content</h6>
          <div className="space-y-1 text-xs">
        ...
        <div className="col-span-2 md:col-span-1 bg-amber-500/10 rounded-xl p-3 border border-amber-500/30">
          <h6 className="text-amber-400 font-bold text-sm mb-2">💳 Wallet</h6>
          <div className="space-y-1 text-xs">
        ...
        <div className="col-span-2 md:col-span-1 bg-pink-500/10 rounded-xl p-3 border border-pink-500/30">
          <h6 className="text-pink-400 font-bold text-sm mb-2">🎁 Reward</h6>
          <div className="space-y-1 text-xs">
        ...
        <div className="col-span-2 md:col-span-1 bg-purple-500/10 rounded-xl p-3 border border-purple-500/30">
          <h6 className="text-purple-400 font-bold text-sm mb-2">🔐 Auth</h6>
          <div className="space-y-1 text-xs">
        ...
        <div className="col-span-2 md:col-span-1 bg-slate-500/10 rounded-xl p-3 border border-slate-500/30">
          <h6 className="text-slate-400 font-bold text-sm mb-2">⚙️ System</h6>
          <div className="space-y-1 text-xs">
...
// Edge Functions Diagram
export const EdgeFunctionsDiagram: React.FC = () => (
  <DiagramWrapper title="Edge Functions Overview">
    <div className="w-full max-w-5xl">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* Auth */}
        <div className="bg-blue-500/10 rounded-xl p-4 border border-blue-500/30">
          <h6 className="text-blue-400 font-bold text-sm mb-3">🔐 Authentication</h6>
        ...
        <div className="bg-amber-500/10 rounded-xl p-4 border border-amber-500/30">
          <h6 className="text-amber-400 font-bold text-sm mb-3">💳 Wallet</h6>
          <div className="space-y-2 text-xs">
        ...
        <div className="bg-purple-500/10 rounded-xl p-4 border border-purple-500/30">
          <h6 className="text-purple-400 font-bold text-sm mb-3">🖼️ Media</h6>
          <div className="space-y-2 text-xs">
        ...
        {/* Migration */}
        <div className="bg-emerald-500/10 rounded-xl p-4 border border-emerald-500/30">
          <h6 className="text-emerald-400 font-bold text-sm mb-3">🔄 Migration</h6>
          <div className="space-y-2 text-xs">
        ...
        <div className="bg-red-500/10 rounded-xl p-4 border border-red-500/30">
          <h6 className="text-red-400 font-bold text-sm mb-3">🧹 Cleanup</h6>
          <div className="space-y-2 text-xs">
        ...
        <div className="bg-slate-500/10 rounded-xl p-4 border border-slate-500/30">
          <h6 className="text-slate-400 font-bold text-sm mb-3">👨‍💼 Admin</h6>
          <div className="space-y-2 text-xs">
  ...
  <DiagramWrapper title="Security Features">
    <div className="w-full max-w-4xl">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-emerald-500/10 rounded-xl p-4 border border-emerald-500/30">
          <h6 className="text-emerald-400 font-bold mb-3">🛡️ Row Level Security</h6>
        ...
        <div className="bg-blue-500/10 rounded-xl p-4 border border-blue-500/30">
          ...
          <div className="space-y-2 text-sm text-muted-foreground">
            <div className="bg-background/50 rounded px-3 py-2">Posts: 10/phút</div>
            <div className="bg-background/50 rounded px-3 py-2">Comments: 30/phút</div>
            <div className="bg-background/50 rounded px-3 py-2">Searches: 60/phút</div>
          </div>
        </div>
