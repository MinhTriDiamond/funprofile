...
function SummaryTable({ summary, activeFilter }: { summary: DonationSummary; activeFilter: DonationFilter }) {
  ...
  return (
    <div className="space-y-3 mb-4">
      ...
      <p className="text-sm text-muted-foreground italic px-1">* Lịch sử giao dịch trong trang cá nhân chỉ bao gồm các giao dịch tặng/nhận, swap và chuyển ví thực hiện qua FUN.RICH.</p>
