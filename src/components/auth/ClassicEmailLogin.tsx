...
export const ClassicEmailLogin = ({ onSuccess }: ClassicEmailLoginProps) => {
  const { t } = useLanguage();
    ...
    <div className="space-y-5">
      <div className="text-center space-y-2">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-slate-100 mb-2">
          <KeyRound className="text-slate-600" size={28} />
        </div>
        ...
        {!isLogin && (
          <div className="space-y-2">
            ...
            <Input
              ...
              className="h-12 rounded-xl border-2 border-slate-300 bg-gradient-to-br from-white to-slate-50 focus:border-emerald-400 focus:ring-4 focus:ring-emerald-400/30 transition-all"
            />
          </div>
        )}
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <Input
              ...
              className="h-12 rounded-xl pr-10 border-2 border-slate-300 bg-gradient-to-br from-white to-slate-50 focus:border-emerald-400 focus:ring-4 focus:ring-emerald-400/30 transition-all"
            />
            <button
              type="button"
