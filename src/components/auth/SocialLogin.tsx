...
export const SocialLogin = ({
  ...
  return <div className="space-y-6">
      ...
      {/* Google Sign In Button - Pill shape with rainbow gradient */}
      <Button 
        type="button" 
        className="w-full h-14 text-white font-bold transition-all flex items-center justify-center gap-3 rounded-full text-lg relative overflow-hidden group" 
        onClick={handleGoogleSignIn} 
        disabled={googleLoading} 
        style={{
          background: 'linear-gradient(90deg, #FF0000 0%, #FF7F00 16%, #FFFF00 33%, #00FF00 50%, #0000FF 66%, #4B0082 83%, #9400D3 100%)',
