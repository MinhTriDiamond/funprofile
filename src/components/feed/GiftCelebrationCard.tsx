...
const FLOATING_COINS = [
  // Hàng trên
  { top: '5%', left: '3%', size: 36, delay: '0s', anim: 'animate-float-coin' },
  { top: '8%', left: '25%', size: 28, delay: '0.7s', anim: 'animate-sparkle-coin' },
  { top: '3%', left: '50%', size: 40, delay: '1.3s', anim: 'animate-float-coin' },
  { top: '10%', right: '8%', size: 48, delay: '0.5s', anim: 'animate-sparkle-coin' },
  // Hàng giữa trên
  { top: '25%', left: '8%', size: 32, delay: '1.8s', anim: 'animate-sparkle-coin' },
  { top: '30%', left: '40%', size: 24, delay: '0.3s', anim: 'animate-float-coin' },
  { top: '28%', right: '5%', size: 44, delay: '2.2s', anim: 'animate-float-coin' },
  // Hàng giữa
  { top: '45%', left: '3%', size: 32, delay: '1s', anim: 'animate-float-coin' },
  { top: '50%', left: '60%', size: 28, delay: '1.5s', anim: 'animate-sparkle-coin' },
  { top: '48%', right: '10%', size: 36, delay: '0.2s', anim: 'animate-float-coin' },
  // Hàng giữa dưới
  { top: '60%', left: '15%', size: 40, delay: '1.2s', anim: 'animate-sparkle-coin' },
  { top: '65%', left: '75%', size: 32, delay: '2s', anim: 'animate-float-coin' },
  // Hàng dưới
  { top: '75%', left: '5%', size: 36, delay: '0.8s', anim: 'animate-float-coin' },
  { top: '78%', left: '35%', size: 44, delay: '1.6s', anim: 'animate-sparkle-coin' },
  { top: '80%', right: '12%', size: 52, delay: '2s', anim: 'animate-sparkle-coin' },
  { top: '85%', left: '55%', size: 28, delay: '0.4s', anim: 'animate-float-coin' },
];
...
const GiftCelebrationCardComponent = ({
  ...
  return (
    <div
      ref={cardRef}
      className={`mb-3 overflow-hidden rounded-xl animate-fade-in relative ${isNew ? 'animate-pulse' : ''}`}
      style={{
        background: 'linear-gradient(135deg, #0d4a2a 0%, #166534 25%, #1a7d45 50%, #166534 75%, #0d4a2a 100%)',
        border: isNew
    ...
    >
      ...
      <div className="p-3 pt-2">
        ...
        <div className="text-center mb-2">
          <p className="text-base font-bold text-white leading-snug" style={{ textShadow: '0 1px 3px rgba(0,0,0,0.3)' }}>
            {isTreasurySender ? (
        ...
        {/* Gift message */}
        {displayMessage && (
          <div className="bg-white/15 backdrop-blur-sm rounded-lg px-2 py-1.5 mb-2 text-center">
