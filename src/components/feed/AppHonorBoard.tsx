      ...
      <div className="relative p-3 space-y-3">
        ...
        <div className="grid grid-cols-1 gap-2">
          {statItems.map((item, index) => (
            <div 
              key={index} 
              className="flex items-center gap-3 py-3 px-4 rounded-lg transition-all duration-300 hover:scale-[1.02] cursor-pointer border-2 border-[#DAA520] shadow-[0_2px_6px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.1)]"
              style={{
                background: '#013220',
              }}
            >
