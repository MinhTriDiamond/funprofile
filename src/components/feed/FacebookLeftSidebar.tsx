...
export const FacebookLeftSidebar = ({ onItemClick }: FacebookLeftSidebarProps) => {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="bg-card/70 backdrop-blur-sm rounded-xl border-2 border-yellow-400/50 p-4 hover:border-yellow-400 hover:shadow-[0_0_20px_rgba(250,204,21,0.3)] transition-all duration-300">
