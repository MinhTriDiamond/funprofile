        ...
        {latestEpoch ? (
          <div className="rounded-lg border border-border p-3.5 space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-sm text-foreground">{formatMonth(latestEpoch.epoch_month)}</span>
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="text-center p-2 rounded-md bg-muted/40">
                <div className="font-bold text-sm text-foreground">{formatFUN(latestEpoch.mint_pool)}</div>
                <div className="text-[10px] text-muted-foreground">Pool</div>
              </div>
              <div className="text-center p-2 rounded-md bg-muted/40">
                <div className="font-bold text-sm text-foreground">{formatFUN(latestEpoch.total_light_score)}</div>
              ...
              <div className="text-center p-2 rounded-md bg-muted/40">
                <div className="font-bold text-sm text-foreground flex items-center justify-center gap-1">
                  <Users className="w-3 h-3" />{latestEpoch.eligible_users}
                </div>
            ...
            {allocation ? (
              <div className="border-t border-border pt-3 space-y-3">
                ...
                {isClaimed ? (
                  ...
                  <p className="text-center py-2 text-sm text-muted-foreground">Không có FUN để claim.</p>
                )}
              </div>
            ) : (
              <p className="text-center py-3 text-sm text-muted-foreground">Không có allocation trong epoch này.</p>
            )}
          </div>
        ) : (
