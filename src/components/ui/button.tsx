...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-gradient-to-r from-primary via-green-400 to-primary text-white font-semibold rounded-full border-[3px] border-transparent bg-clip-padding shadow-[0_0_8px_rgba(255,215,0,0.7),0_0_20px_rgba(255,215,0,0.4),0_0_40px_hsl(var(--gold)/0.5),inset_0_1px_1px_rgba(255,255,255,0.4)] hover:shadow-[0_0_12px_rgba(255,215,0,0.9),0_0_30px_rgba(255,215,0,0.6),0_0_60px_hsl(var(--gold)/0.7),inset_0_1px_2px_rgba(255,255,255,0.6)] hover:scale-105 duration-300 relative before:absolute before:inset-0 before:rounded-full before:p-[3px] before:bg-gradient-to-b before:from-[#FFD700] before:via-[#FFC125] before:to-[#DAA520] before:-z-10 before:content-[''] after:absolute after:inset-[3px] after:rounded-full after:bg-gradient-to-r after:from-primary after:via-green-400 after:to-primary after:-z-[5] after:content-['']",
        destructive: "bg-gradient-to-r from-red-600 via-red-500 to-red-600 text-white font-semibold rounded-full border-[3px] border-transparent shadow-[0_0_8px_rgba(255,215,0,0.6),0_0_20px_rgba(255,215,0,0.3),0_0_30px_rgba(239,68,68,0.4)] hover:shadow-[0_0_12px_rgba(255,215,0,0.8),0_0_30px_rgba(255,215,0,0.5),0_0_40px_rgba(239,68,68,0.6)] hover:scale-105 duration-300 relative before:absolute before:inset-0 before:rounded-full before:p-[3px] before:bg-gradient-to-b before:from-[#FFD700] before:via-[#FFC125] before:to-[#DAA520] before:-z-10 before:content-[''] after:absolute after:inset-[3px] after:rounded-full after:bg-gradient-to-r after:from-red-600 after:via-red-500 after:to-red-600 after:-z-[5] after:content-['']",
        outline: "bg-transparent text-foreground font-semibold rounded-full border-[3px] border-transparent shadow-[0_0_8px_rgba(255,215,0,0.5),0_0_15px_rgba(255,215,0,0.3)] hover:shadow-[0_0_12px_rgba(255,215,0,0.7),0_0_25px_rgba(255,215,0,0.5)] hover:scale-105 duration-300 backdrop-blur-sm relative before:absolute before:inset-0 before:rounded-full before:p-[3px] before:bg-gradient-to-b before:from-[#FFD700] before:via-[#FFC125] before:to-[#DAA520] before:-z-10 before:content-[''] after:absolute after:inset-[3px] after:rounded-full after:bg-background/80 after:-z-[5] after:content-['']",
        secondary: "bg-secondary text-secondary-foreground font-semibold rounded-full border-[3px] border-transparent shadow-[0_0_6px_rgba(255,215,0,0.4)] hover:shadow-[0_0_10px_rgba(255,215,0,0.6)] hover:scale-105 duration-300 relative before:absolute before:inset-0 before:rounded-full before:p-[3px] before:bg-gradient-to-b before:from-[#FFD700] before:via-[#DAA520] before:to-[#B8860B] before:-z-10 before:content-[''] after:absolute after:inset-[3px] after:rounded-full after:bg-secondary after:-z-[5] after:content-['']",
        ghost: "hover:bg-accent/10 hover:text-accent-foreground rounded-md",
        link: "text-primary underline-offset-4 hover:underline",
        premium: "bg-gradient-to-r from-primary via-green-400 to-primary text-white font-bold rounded-full border-[3px] border-transparent shadow-[0_0_10px_rgba(255,215,0,0.8),0_0_25px_rgba(255,215,0,0.5),0_0_50px_hsl(var(--gold)/0.6),0_0_80px_hsl(var(--gold)/0.4)] hover:shadow-[0_0_15px_rgba(255,215,0,1),0_0_35px_rgba(255,215,0,0.7),0_0_70px_hsl(var(--gold)/0.8),0_0_100px_hsl(var(--gold)/0.6)] hover:scale-105 duration-300 relative before:absolute before:inset-0 before:rounded-full before:p-[3px] before:bg-gradient-to-b before:from-[#FFE55C] before:via-[#FFD700] before:to-[#DAA520] before:-z-10 before:content-[''] after:absolute after:inset-[3px] after:rounded-full after:bg-gradient-to-r after:from-primary after:via-green-400 after:to-primary after:-z-[5] after:content-['']",
        light: "bg-gradient-to-r from-primary via-green-400 to-primary text-white font-semibold rounded-full border-[3px] border-transparent shadow-[0_0_10px_rgba(255,215,0,0.7),0_0_25px_rgba(255,215,0,0.4),0_0_50px_hsl(var(--gold)/0.5)] hover:shadow-[0_0_15px_rgba(255,215,0,0.9),0_0_35px_rgba(255,215,0,0.6),0_0_70px_hsl(var(--gold)/0.7)] hover:scale-105 duration-300 relative before:absolute before:inset-0 before:rounded-full before:p-[3px] before:bg-gradient-to-b before:from-[#FFD700] before:via-[#FFC125] before:to-[#DAA520] before:-z-10 before:content-[''] after:absolute after:inset-[3px] after:rounded-full after:bg-gradient-to-r after:from-primary after:via-green-400 after:to-primary after:-z-[5] after:content-['']",
      },
      size: {
