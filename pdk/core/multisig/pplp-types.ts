// =============================================
// PPLP Types & Constants - Portable Package
// Dùng cho: FUN Profile, FUN Play, ANGEL AI
// =============================================

// Action Types - Mỗi platform có thể thêm action riêng
...
// Base Rewards (Policy v1.0.1) - FUN tokens per action
...
// 5 Pillars of Light (Ngũ Trụ Ánh Sáng)
...
export const SCORE_RANGES = {
  Q: { min: 0.5, max: 3.0, default: 1.0 },  // Quality
  I: { min: 0.5, max: 5.0, default: 1.0 },  // Impact
  K: { min: 0.0, max: 1.0, default: 1.0 },  // Integrity (K = không gian lận)
};
...
// Distribution tiers (Thác đổ 3 cấp)
...
export interface MintRequest {
  ...
  // Multisig fields
  multisig_signatures?: Record<string, unknown>;
...
/** Tính toán phân phối thác đổ 3 cấp */
